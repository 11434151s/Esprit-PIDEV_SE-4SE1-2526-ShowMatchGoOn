...
/**
 * Documentary Data Transfer Object
 */
...
/**
 * Content API Service
 * WHY: Centralized API calls for content management
 * Provides CRUD operations for all content types (Films, Series, Documentaries)
 */
@Injectable({
  providedIn: 'root'
})
