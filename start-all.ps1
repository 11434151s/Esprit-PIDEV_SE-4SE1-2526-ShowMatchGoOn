...
$jarPath = "backend/target/content-management-0.0.1-SNAPSHOT.jar"
...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "Push-Location 'backend'; java -jar target/content-management-0.0.1-SNAPSHOT.jar"
Start-Sleep -Seconds 3

Write-Host "Starting Frontend on port 4200..." -ForegroundColor Yellow
Start-Process powershell -ArgumentList "-NoExit", "-Command", "Push-Location 'frontend'; npm start"
Start-Sleep -Seconds 2

Write-Host "Populating test data..." -ForegroundColor Yellow
Start-Process powershell -ArgumentList "-NoExit", "-Command", "node populate-db.js"
